...
function renderDashboard(data) {
  ...
  overview.append(
    ...
    kpi("방문량 대비 관광소비 상대지수", value(west.consumptionIndex), "2026.07 구 평균 · 금액 아님", relativeToEast(west.consumptionIndex, east.consumptionIndex), "한국관광공사 원천 산식은 전체 관광소비액 ÷ 전체 방문량입니다. 신한·BC카드 관광소비액과 SKT 방문량을 결합한 뒤 KTO가 제공한 월별 시군구 지표값을 이 화면에서 권역 내 구 단위로 평균합니다. 지역 간 소비 수준 비교에만 사용하며 원화 금액·점유율로 해석하지 않습니다."),
